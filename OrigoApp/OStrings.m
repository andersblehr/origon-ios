...
NSString * const strSheetPromptCountry               = @"strSheetPromptCountry";
NSString * const strSheetPromptOrigoType             = @"strSheetPromptCountry";
...
NSString * const strButtonAllMembers                 = @"strButtonAllMembers";
