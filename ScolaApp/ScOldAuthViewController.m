...
#import "ScOldAuthViewController.h"
...
@implementation ScOldAuthViewController
...
- (BOOL)isInputValid
{
    ...
    switch (authPhase) {
        case ScAuthPhaseLogin:
            isValid = isValid && [ScMeta isEmailValid:nameOrEmailOrRegistrationCodeField];
        ...
        case ScAuthPhaseRegistration:
            isValid = isValid && [ScMeta isNameValid:nameOrEmailOrRegistrationCodeField];
            isValid = isValid && [ScMeta isEmailValid:emailOrPasswordField];
            isValid = isValid && [self isPasswordValid];
...
- (void)registerUser
{
    ...
    [serverConnection authenticateForPhase:ScAuthPhaseRegistration delegate:self];
