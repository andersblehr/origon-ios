...
- (void)save
{
    ...
    if ([self save:&error]) {
        ...
        [OAlert showAlertWithTitle:OLocalizedString(@"Data error", @"") message:[NSString stringWithFormat:OLocalizedString(@"An unrecoverable data error has occurred. To ensure the continued integrity of your data, you must delete and reinstall %@ on this device.", @""), [OMeta m].appName]];
